...
//!
//! Consumes [`parapet_core::WidgetData::Clock`] and updates the label text.
//! All formatting is done in `parapet_core::widgets::clock::ClockWidget`; this
//! renderer only applies the resulting `display` string to the GTK widget.

use gtk::prelude::*;

use parapet_core::{ClockConfig, WidgetData};
