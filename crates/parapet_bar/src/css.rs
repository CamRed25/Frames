//! CSS theme loading for the Parapet bar.
//!
//! Loads CSS into a [`gtk::CssProvider`] and applies it globally. The load
//! priority chain is:
//! 1. CLI `--theme <name>` override → `~/.config/parapet/themes/<name>.css`
//! 2. `bar.theme` config field → `~/.config/parapet/themes/<name>.css`
...
pub enum ThemeSource<'a> {
    /// Named theme: resolved to `~/.config/parapet/themes/<name>.css`.
    ///
...
///
/// Resolves to `~/.config/parapet/themes/<name>.css` using the `HOME`
...
mod tests {
    ...
    fn resolve_theme_path_correct() {
        ...
        assert_eq!(p, PathBuf::from("/home/testuser/.config/parapet/themes/dark.css"));
    }
